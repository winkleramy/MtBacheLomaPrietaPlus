...
lyr_WaterSources_5.set('fieldAliases', {'id': 'id', 'type': 'type', 'gallons': 'gallons', 'material': 'material', 'source': 'source', 'address': 'address', 'Latitude': 'Latitude', 'Longitude': 'Longitude', });
...
lyr_WaterSources_5.set('fieldImages', {'id': 'Hidden', 'type': 'TextEdit', 'gallons': 'TextEdit', 'material': 'TextEdit', 'source': 'TextEdit', 'address': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', });
...
lyr_WaterSources_5.set('fieldLabels', {'type': 'inline label - visible with data', 'gallons': 'inline label - visible with data', 'material': 'inline label - visible with data', 'source': 'inline label - visible with data', 'address': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', });

...
var format_WaterSources_6 = new ol.format.GeoJSON();
var features_WaterSources_6 = format_WaterSources_6.readFeatures(json_WaterSources_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_WaterSources_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_WaterSources_6.addFeatures(features_WaterSources_6);
var lyr_WaterSources_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_WaterSources_6, 
                style: style_WaterSources_6,
                popuplayertitle: 'WaterSources',
                interactive: true,
                title: '<img src="styles/legend/WaterSources_6.png" /> WaterSources'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_AssessorParcels_1.setVisible(true);lyr_CommunityBoundary_2.setVisible(true);lyr_FirewiseSignLocations_3.setVisible(true);lyr_RefugeAreas_4.setVisible(true);lyr_EmergencyVehicleTurnArounds_5.setVisible(true);lyr_WaterSources_6.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_AssessorParcels_1,lyr_CommunityBoundary_2,lyr_FirewiseSignLocations_3,lyr_RefugeAreas_4,lyr_EmergencyVehicleTurnArounds_5,lyr_WaterSources_6];
...
lyr_WaterSources_6.set('fieldAliases', {'id': 'id', 'type': 'type', 'gallons': 'gallons', 'material': 'material', });
...
lyr_WaterSources_6.set('fieldImages', {'id': 'Hidden', 'type': 'TextEdit', 'gallons': 'TextEdit', 'material': 'TextEdit', });
...
lyr_WaterSources_6.set('fieldLabels', {'type': 'inline label - visible with data', 'gallons': 'inline label - visible with data', 'material': 'inline label - visible with data', });

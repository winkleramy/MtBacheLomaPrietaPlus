...
lyr_WaterSources_5.set('fieldLabels', {'type': 'inline label - visible with data', 'gallons': 'inline label - visible with data', 'material': 'inline label - visible with data', 'source': 'inline label - visible with data', 'address': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - always visible', 'Notes': 'hidden field', });
